return {
    ...
    dependencies = {
        ...
        "zane-/cder.nvim",
        -- { dir = "/Users/ashishalex/Documents/personal/repos/telescope-frecency.nvim"} ,
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader>f', ':Telescope frecency workspace=CWD theme=ivy<CR>', {})
        ...
        vim.keymap.set('n', '<leader>df',
            function() -- make it easier to search Dataform files references by $ref{file_name}
                local word = vim.fn.expand("<cword>")
