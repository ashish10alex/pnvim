...
return {
	{
		...
		config = function()
			require("nvim-treesitter.configs").setup({
				...
				ensure_installed = {
                    "lua", "python", "vimdoc", "vim", "html", "tsx", "javascript", "typescript", "json", "yaml",  "go", "sql", "mermaid", "http", "markdown", "markdown_inline", "luadoc", "query", "c", "hcl", "terraform", "gitignore", "bash"
                },
